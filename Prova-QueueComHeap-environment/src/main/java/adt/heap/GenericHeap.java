...
public interface GenericHeap<T extends Comparable<T>> {
	 ...
	 * build a new heap using the array received as a parameter. 
	 * The method returns a copy (another array) containing only the not null 
	 * elements of the internal array. At the end, the internal array should be empty.
	 * This method simply extracts the elements of the head and puts them into an auxiliary 
